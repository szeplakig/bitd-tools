...
const bargainTypeList = Array.from(
  new Set(devils_bargains_data.map((e) => e.type))
);

const DevilsBargain = () => {
  const [selectedBargain, setSelectedBargain] = React.useState(
    rollArray(devils_bargains_data)
  );
