...
=======
  {
    ...
    assets: ["A large gang of bloodthirsty butchers", "A pack of death-dogs"],
    quirks:
  ...
  },
  {
    ...
    turf: "The city council chambers are in Charterhall, along with the attendant government offices and impregnable city treasury vaults. The council also holds ownership of all public spaces in the city, including streets, docks, and waterways.",
    npc_detail: "The scions of the six most powerful noble families in Doskvol",
    npcs: ["Bowmore", "Clelland", "Dunvil", "Penderyn", "Rowan", "Strangford"],
    ...
    quirks:
      "The members of the Council are all high-ranking adepts in the Church of the Ecstasy of the Flesh. Some of them are also secretly initiates in the Path of Echoes.",
    ...
    situation:
      "Three of the councilors (Bowmore, Clelland, Rowan) have aligned against Strangford and are maneuvering to remove the house from the council. Dunvil and Penderyn have not taken sides so far. Can the conspirators arrange for the necessary scandal, framed crime, or assassinations to remove Strangford? Or can Strangford House stand against them and eliminate the threats?",
  },
  {
    name: "The Crows",
    tier: 2,
    ...
    allies: ["The Bluecoats", "Sailors", "The Lost", "Citizens of Crow’s Foot"],
  ...
  },
  {
    ...
    quirks:
      "Possession is a common hazard, and scavengers either learn to deal with it, or go mad and vanish into the darkness of the wastes. Those still in Lady Thorn’s company have adapted well and suffer only minimal ill effects from possession.",
  ...
  },
  {
    ...
    allies: ["The Lampblacks", "Citizenry of all districts"],
  ...
  },
  {
    ...
    allies: ["The Inspectors"],

    enemies: ["Bluecoats", "Lord Strangford (Leviathan Hunters)"],
  ...
  },
  {
    ...
    enemies: ["The Circle of Flame", "The Unseen", "The Crows", "The Wraiths"],
  ...
  },
  {
    ...
    quirks:
      "Bazso Baz is a member of a secret society (forgotten gods cult, “The Empty Vessel”) and sometimes puts the needs of that group ahead of the well-being of his gang.",
  ...
  },
  {
    ...
    npcs: ["Cortland (leader, idealist, candid, cavalier)"],
    ...
    enemies: ["Workhouse Foremen", "Bluecoats", "The Billhooks"],
  ...
  },
  {
    ...
    quirks:
      "The spirits of the Reconciled do not lose their minds or become obsessed with vengeance as other spirits do. They can possess a victim indefinitely without any adverse effects.",
  ...
  },
  {
    ...
    quirks:
      "Scurlock is immune to spirits. Ghosts can’t see, hear, or harm him. He makes no sound when he moves and is sometimes difficult to look at directly.",
  ...
  },
  {
    ...
    turf: "Bellweather Crematorium. The Master Warden’s estate in Whitecrown.",
    npc_detail:
      "There are no known Spirit Wardens—they maintain an anonymous membership of people not native to Duskwall, using code-names.",
    npcs: [
      "A Warden known as “Bakoros” (who may be several different individuals) sometimes lectures at the College of Immortal studies at Doskvol Academy",
    ],
    ...
    quirks:
      "Membership in the Wardens is secret and utterly anonymous. They cut all ties and have no families or close relationships, save their fellow Wardens.",
...
export default faction_data;
>>>>>>> d9195aa4a2cf421e12226af204d48fa1a1489506
